  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="border-border bg-card text-foreground placeholder:text-muted-foreground h-12 w-full rounded-full border pr-4 pl-11 text-sm shadow-sm outline-none transition-colors focus:border-[var(--brand)]"
      />
    </form>
  );
}
