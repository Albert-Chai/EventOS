...
/**
 * Guards a post id taken straight from the URL, so a garbled one 404s instead of
 * reaching Postgres as a `uuid` comparison and surfacing as a 500. See
 * `lib/uuid.ts` for why that distinction matters.
 */
