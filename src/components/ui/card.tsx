...
/**
 * `as` added to the stock shadcn primitive: when a card title is also the
 * page's or a section's heading, it must be a real heading element or the page
 * has no document outline for a screen reader to navigate (spec §18,
 * "Accessible"). Defaults to `div` so existing decorative uses are unchanged.
 */
function CardTitle({
  className,
  as: Component = "div",
